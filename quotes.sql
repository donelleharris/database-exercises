...
INSERT INTO quotes (author_first_name, author_last_name, content)
VALUES ('Samuel',    'Clemens',    'Clothes make the man. Naked people have little or no influence on society.'),
       ('Kurt',    'Vonnegut', 'The universe is a big place, perhaps the biggest.'),
       ('Carol', 'Dweck', 'Love challenges, be intrigued by mistakes, enjoy effort and keep on learning.');